...
String str= "Java, candir." ;
        ...
        System.out.println(cumle2.length());// 18 // stringdeki length methodunda parantez var
        
        String harfArrayi[]=cumle2.split("");
        System.out.println(harfArrayi.length); // 18  // arrays de length methodunda parantez yok
