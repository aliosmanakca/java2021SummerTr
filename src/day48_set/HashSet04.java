...
public class HashSet04 {
	...
	public static void main(String[] args) {
	     ...
	     */
	        ...
	        System.out.println(toplaminiAl(setOlustur(hs)));
	        
	    }
	    public static HashSet<Double> setOlustur(@SuppressWarnings("rawtypes") HashSet h) {
 	        HashSet<Double> a = new HashSet<>(Arrays.asList(3.23, 3.10, 5.12, 10.12, 23.12));
	        return a; 
	    }
