...
public class Queue01 {
	...
	public static void main(String[] args) {
		...
		q1.add("sedef");
		q1.add("ahmet");
		System.out.println(q1);// [basri, hakan, sedef, ahmet]--> java LinkedList geregi insettion order'e gore
								// sia olsuturdu
		...
		q2.add("yagmur");
		q2.add("mehmet");
		System.out.println(q2);// [mehmet, oguz, yagmur, rabia]--> java kendi PriorityQueue(oncelik sirasi)
								// algoritmasini calistirdi
		...
		//System.out.println(q1.remove());// bos bir obj den ilk eleman silip return etme komutu girdik-->
										// NoSuchElementException
		// q1.remove();
		// System.out.println(q1);//[sedef, ahmet]
		
		System.out.println(q1.offer("merve")); // true. Eleman siniri konulduysa add methodu hata verir ama offerda hata olmaz.
