...
public class Map02 {
	...
	public static void main(String[] args) {
		...
		m1.remove(102, "said");// key value eslesmsi olursa entry silinir eslesme olmazsa (said!=Said) herhangi
								// bir islem yapilmaz.
		System.out.println(m1);// {102=Said, 103=Hasan, 104=Canan, 105=Ayse}
		m1.remove(102, "Said");
		...
		// Trick of day : putAll() methodu calismasi icin her iki map'in Data type'lari
		// eslesmeli
		...
		System.out.println(m1);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse}--> 103 key'deki
								// hasan haluk olarak update edildi.
		
		m1.compute(109, (key, value) -> "merve hanım");// 109 key'de olnadigi icin Entry' put eder
		
		System.out.println(m1);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse,109=merve
								// hanım}--> 109 key'deki 109=merve hanım creat edildi
		
		m1.computeIfAbsent(111, value -> "said ipek");// map'de 111 key varligini kontrol eder 111 key yoksa girilen
														// value(said ipek) atanir. 111 key varsa islem yapilmaz
		System.out.println(m1);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse,109=merve hanım,
								// 111=said ipek}--> 111 key'deki 111=said ipek creat edildi
		
		m1.computeIfAbsent(109, value -> "ipek");// map'de 109 key varligini kontrol eder. 109 key oldg icin islem
													// yapilmaz
		System.out.println(m1);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse,109=merve hanım,
								// 111=said ipek}-->
